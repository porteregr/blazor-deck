...
namespace BlazorDeck.Client
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var environmentBaseAddress = builder.HostEnvironment.BaseAddress;
            builder.Services.AddScoped(sp => new HttpClient { BaseAddress = environmentBaseAddress.EndsWith("0.0.0.0/") ? new Uri("https://modbro.porteregr.com") : new Uri(builder.HostEnvironment.BaseAddress) });
