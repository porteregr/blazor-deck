...
namespace TileConfigGenerator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var monitor0 = new TileDefinition(new PrimaryMonitorAction(0), new IconTileDisplayDefinition("fa-desktop", paleGreen, white), "Monitor 1", 0f);
            var monitor1 = new TileDefinition(new PrimaryMonitorAction(2), new IconTileDisplayDefinition("fa-desktop", paleGreen, white), "Monitor 3", 2f);
            var monitor2 = new TileDefinition(new PrimaryMonitorAction(1), new IconTileDisplayDefinition("fa-desktop", paleGreen, white), "Monitor 2", 3f);
